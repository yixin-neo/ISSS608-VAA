...
Let us examine the trading patterns of 'Volga River LLC Enterprises', the third in place in terms of ''in-deg' company with its six suppliers (as seen from the interactive graph).
...
girafe(code = print(volga_in1 / volga_in2 / volga_in3 / volga_in4 / volga_in5 / volga_in6),
       #width_svg = 6,
       height_svg =8,
       options = list(
