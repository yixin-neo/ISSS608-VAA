...
## 3.5 Correlationship between partnership intervals (in days) and total number of interactions between company pairs
...
### 3.5.1 Checking for statistical significance in correlationship
...
### 3.5.2 Coordinated and interactive scatterplot 
