...
-   [rstatic](https://rpkgs.datanovia.com/rstatix/): Allows us to perform basic statistical tests with visualisation, including t-test, Wilcoxon test, ANOVA, Kruskal-Wallis and correlation analyses.
