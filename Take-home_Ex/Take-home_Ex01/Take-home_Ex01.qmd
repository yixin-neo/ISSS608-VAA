...
## 3.2 Zooming In: Interactive Line charts of income and expenditures by month

**Design considerations:**

Due to the large difference in values between wage and other expenses, I have separated income and expense into two graphs. This will enable use to visualise the values of the expense clearly.
...
q2<-highlevel %>%
  ...
  geom_text(aes(x=as.Date("2022-12-01"), y=280000, label="Recreationa"), hjust=1, vjust=1, color='purple', size=2.5) +
