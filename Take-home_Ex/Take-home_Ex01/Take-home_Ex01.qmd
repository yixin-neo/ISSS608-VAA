...
## 3.2.1 Distribution of annual wage 
...
sw_t <- shapiro_test(annual$Wage)  %>% gt()  #<<< make into a gt format (will give a nice table)  shapiro.test is not used here as it gives output in another format.
