...
## 3.3 Treemap of business relationship between shipping and receiving companies
...
The largest player here is 'Playa del Tesoro OJSC' (no pun intended) and it ships in high frequency and large volume only to one receiving compmany called 'Fresh Wharf SRL Consulting' over the years 2028 to 2034.

## 3.4 Temporal analysis of top company in trading occurrence over the years

Let us visualise the horizon plot of the number of trading activities of the top 3 companies over the years.
...
## 3.5 Temporal analysis of top 10 'out-deg' centrality companies in trading occurrence over the years
...
Analysis of the plot above: TBC....

## 3.6 Interactive graph grouped by community
