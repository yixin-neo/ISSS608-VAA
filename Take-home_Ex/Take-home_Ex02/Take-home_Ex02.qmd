...
pacman::p_load(jsonlite, igraph, tidygraph, ggraph,
               ...
               tidyverse, graphlayouts,knitr,plotly, ggHoriPlot, ggthemes,treemap)
```
...
## 3.2 Interactive graph grouped by OUT-DEGREE CENTRALITY scores
...
3.5 Temporal analysis of top 10 'in-deg' centrality companies in trading occurrence over the years

Use the code chunk below to get top 10 receiving companies
...
Repeat steps explained earlier
