...
```{r}
in_deg_brks <- c(0, 50, 100, 150, 200, 250, 277)
grps <- c('50 & Below', '51-100', '101-150', '151-200', '201-250', '251-277')

nodes_seafood_vis$in_deg_grp <- cut(nodes_seafood_vis$in_deg_centrality, breaks=in_deg_brks, labels = grps,include.lowest = TRUE)

nodes_seafood_vis$in_deg_grp <- factor(nodes_seafood_vis$in_deg_grp, ordered = TRUE, levels = c('251-277','201-250','151-200','101-150','51-100','50 & Below'))
...
```{r}
out_deg_brks <- c(0, 50, 100, 150, 200, 250, 300, 350)
grps <- c('50 & Below', '51-100', '101-150', '151-200', '201-250', '251-300, 301-307')
...
nodes_seafood_vis$out_deg_grp <- factor(nodes_seafood_vis$out_deg_grp, ordered = TRUE, levels = c('301-307','251-300','201-250','151-200','101-150','51-100','50 & Below'))
...
## 3.3 Interactive graph grouped by  community
