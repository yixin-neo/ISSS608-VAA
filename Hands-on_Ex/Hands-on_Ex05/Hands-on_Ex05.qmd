...
H0: There is no association between mathbin and gender.
...
From the graph above, there is a slight sign of heteroscedasticity as the residuals seem to be funnelled outsides as the fitted values increase.
