...
```{r}
pacman::p_load(plotly, knitr, patchwork, tidyverse, ggthemes,hrbrthemes, ggiraph, ggstatsplot, ggdist, png, gifski, nortest)
```
...
## 3.2 Zooming In: Multiple line chart of income and expenditures by month
...
-   **`size`** parameter in **`geom_line()`** is used to increase the line width.

-   **`scale_linetype_manual()`** is used to set the linetype for Wage and RentAdjustment lines as "dashed".

-   **`labs()`** is used to change the axis labels.
...
-   **`theme_bw()`** is used to set the plot background to white and remove the grid lines.

-   **`element_line()`** is used to increase the axis line width.

-   **`legend.position = "bottom"`** is used to move the legend to the bottom of the plot.

-   **`legend.title = element_blank()`** is used to remove the legend title.

-   **`legend.text = element_text(size = 12)`** is used to increase the legend text size.
...
q<-highlevel %>%
  ggplot(aes(x = date)) +
  geom_line(aes(y = Wage, color = "Wage", linetype = "Wage"), size = 0.5) +
  geom_line(aes(y = RentAdjustment, color = "RentAdjustment", linetype = "RentAdjustment"), size = 0.5) +
  geom_line(aes(y = Education, color = "Education"), size = 0.5) +
  geom_line(aes(y = Recreation, color = "Recreation"), size = 0.5) +
  geom_line(aes(y = Food, color = "Food"), size = 0.5, alpha=0.5) +
  geom_line(aes(y = Shelter, color = "Shelter"), size = 0.5) +
  scale_color_manual(values = c("Wage" = "red", "RentAdjustment" = "blue",
                                "Education" = "green", "Recreation" = "purple",
                                "Food" = "orange", "Shelter" = "gray")) +
  ...
  scale_x_date(date_breaks = '1 month',date_labels = "%b %Y") +
  geom_text(aes(x=as.Date("2022-04-01"), y=5800000, label="High wages \nobserved in \nMarch"), hjust=1, vjust=1, color='red', size=2.5) +
  geom_text(aes(x=as.Date("2022-04-01"), y=1300000, label="Higher recreational \nspendings observed \nin March"), hjust=1, vjust=1, color='purple', size=2.5) +
  ...
  ggtitle("Multiple line chart of income and expenses")
...
q1<-highlevel %>%
  ggplot(aes(x = date)) +
  geom_line(aes(y = Wage, color = "Wage", linetype = "Wage"), size = 1) +
  geom_line(aes(y = RentAdjustment, color = "RentAdjustment", linetype = "RentAdjustment"), size = 1) +
  ...
  labs(x = "Month", y = "Amount") +
  scale_x_date(date_breaks = '1 month',date_labels = "%b %Y") +
  geom_text(aes(x=as.Date("2022-05-01"), y=6000000, label="High wages \nobserved in \nMarch"), hjust=1, vjust=1, color='red', size=2.5) +
...
q2<-highlevel %>%
  ...
  geom_line(aes(y = Education, color = "Education"), size = 1) +
  geom_line(aes(y = Recreation, color = "Recreation"), size = 1) +
  geom_line(aes(y = Food, color = "Food"), size = 1, alpha=0.5) +
  geom_line(aes(y = Shelter, color = "Shelter"), size = 1) +
  ...
  labs(x = "Month", y = "Amount") +
  scale_x_date(date_breaks = '1 month',date_labels = "%b %Y") +
  geom_text(aes(x=as.Date("2022-04-01"), y=700000, label="Higher recreational \nspendings observed \nin March"), hjust=1, vjust=1, color='purple', size=2.5) +
  scale_y_continuous(labels = comma) +
  theme_bw(base_size = 12) +
  theme(axis.title = element_text(size = 14, face = "bold"),
        axis.text = element_text(size = 12),
